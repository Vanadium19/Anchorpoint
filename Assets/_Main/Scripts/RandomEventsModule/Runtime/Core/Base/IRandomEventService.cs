...
namespace RandomEventsModule
{
    ...
    /// </summary>
    /// <remarks>Events are addressed by their definition asset, never by a string identifier.</remarks>
    public interface IRandomEventService
    {
        ...
        /// <summary>Picks and starts one eligible event from each of the scope's pools.</summary>
        RandomEventStartResult StartRandom(RandomEventScope scope, CancellationToken token);
