...
namespace RandomEventsModule
{
    ...
    public abstract class RandomEventSignalRelay : IInitializable, IDisposable
    {
        ...
        /// <summary>Subscribes to the game module's fact.</summary>
        public void Initialize() => Subscribe();

        /// <summary>Unsubscribes from the game module's fact.</summary>
        ...
        /// <summary>Reports the relay's signal to the trigger runner.</summary>
