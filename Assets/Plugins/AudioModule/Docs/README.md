...
Сборка `AudioModule` ни на что из игры не ссылается: список `references` в её `.asmdef` пуст. Ядро переносится в другой проект как есть, вместе с папкой плагина.
